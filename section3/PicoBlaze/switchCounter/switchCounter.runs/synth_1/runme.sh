...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section3/PicoBlaze/switchCounter/switchCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_pico.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embedded_pico.tcl

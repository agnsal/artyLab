...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section 2/GCD/RTL_FSM_DP/RTL_FSM_DP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_msf_dp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gcd_msf_dp.tcl -notrace

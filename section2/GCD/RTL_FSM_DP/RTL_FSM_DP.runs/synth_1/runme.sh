...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section 2/GCD/RTL_FSM_DP/RTL_FSM_DP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_msf_dp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_msf_dp.tcl

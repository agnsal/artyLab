...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section 2/counter/counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hl_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hl_counter.tcl -notrace

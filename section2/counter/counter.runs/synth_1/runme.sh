...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section 2/counter/counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hl_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hl_counter.tcl

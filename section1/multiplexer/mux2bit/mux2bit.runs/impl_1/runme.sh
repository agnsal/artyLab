...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/multiplexer/mux2bit/mux2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2bit.tcl -notrace

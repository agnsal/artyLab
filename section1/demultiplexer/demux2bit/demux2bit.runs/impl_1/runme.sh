...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section1/demultiplexer/demux2bit/demux2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demux2bit.tcl -notrace

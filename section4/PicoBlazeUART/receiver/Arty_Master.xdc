...
create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 5} [get_ports { clk }]; #50 MHz
#set_property DONT_TOUCH TRUE [get_cells processor/data_path_loop[1].alu_mux_lut];

...
HD_PWD='C:/Users/Agnese/Desktop/HOMELABS/2-ArtyFPGA/workspaces/section4/PicoBlazeUART/transmitter/transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_pico.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source embedded_pico.tcl -notrace
